...
import { ReservationCreateDialog } from "@/features/booking/ui/reservation-create-dialog";
import { ReservationTimelineCard } from "@/features/booking/ui/reservation-timeline-card";
import { EmptyState, StatusBadge } from "@/shared/components/ui";
import { getResourceTypeLabel, getStatusLabel } from "@/shared/lib/format";
              ...
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {resource.amenities.map((amenity) => (
                    <span key={amenity} className={ui.tag}>
                      {amenity}
                    </span>
                  ))}
                </div>
