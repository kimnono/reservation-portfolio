...
import { useCancelBooking, useBookingDetail } from "@/features/booking/hooks/use-booking-queries";
  ...
  if (isLoading || !data) {
    return (
      <section className="mx-auto max-w-4xl px-6 py-10">
        <div className={`h-80 ${ui.skeletonBlock}`} />
      </section>
    );
  }
      ...
      <Card>
        ...
        <div className="mt-8">
          <button
            ...
            className={`${ui.primaryAction} disabled:opacity-50`}
          >
            예약 취소
          </button>
        </div>
