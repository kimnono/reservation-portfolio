...
import { useCreateBooking } from "@/features/booking/use-booking-queries";
import {
...
import { StatusBadge } from "@/common/components/patterns";
        ...
        <div className="px-6 py-5">
          ...
          <form className="mt-6 grid gap-5 md:grid-cols-2" onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormField label="자원" className="md:col-span-2">
              <Input value={resource.name} disabled className="opacity-80" />
            </FormField>
